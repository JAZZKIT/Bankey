...
extension AccountSummaryCell {
    ...
    private func layout() {
        NSLayoutConstraint.activate([
            ...
            nameLabel.leadingAnchor.constraint(equalTo: dividerView.leadingAnchor),
    ...
    private func makeFormattedBalance(dollars: String, cents: String) -> NSMutableAttributedString {
        ...
        let rootString = NSMutableAttributedString(string: "CA$", attributes: dollarSignAttributes)
